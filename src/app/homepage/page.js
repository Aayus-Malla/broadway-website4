    ...
    return(
        ...
        <div className='about'>
            <div className='row g-1'>
                <div className='col-md-6'>
                    <div className='about1'>
                        <Image src='/1.jpeg' alt='' fill loading='lazy'/>
                    </div>
                </div>

                <div className='col-md-3'>
                    <div className='about1'>
                        <Image src='/3.jpeg' alt='' fill loading='lazy'/>
                    </div>
                </div>

                <div className='col-md-3 mb-1'>
                    <div className='about1'>
                        <Image src='/4.jpeg' alt='' fill loading='lazy'/>
                    </div>
                </div>
            </div>
            ...
            <div className='row g-1'>
                <div className='col-md-3'>
                    <div className='about1'>
                        <Image src='/5.jpeg' alt='' fill loading='lazy'/>
                    </div>
                </div>

                <div className='col-md-3'>
                    <div className='about1'>
                        <Image src='/6.jpeg' alt='' fill loading='lazy'/>
                    </div>
                </div>

                <div className='col-md-6'>
                    <div className='about1'>
                        <Image src='/2.jpeg' alt='' fill loading='lazy'/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="m container mt-5 mb-5">
            <div className="row">
                <div className="col-md-12">
                    <div className="m1">LATEST NEWS</div>
                </div>
            </div>
        </div>
